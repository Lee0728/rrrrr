...
NSString* TSXrotateactive;
NSString* TSXrotatedeactive;
@interface RDPSessionViewController : UIViewController <RDPSessionDelegate,TouchPointerDelegate, AdvancedKeyboardDelegate, RDPKeyboardDelegate, RDPSessionViewDelegate,FileViewControllerDelegate,UIScrollViewDelegate, UITextFieldDelegate>
{
	...
	UITextField* _dummy_textfield;
    int Cnlength;
    NSString *text;
    NSString *sysversion1;
...
@end
@protocol RDPSessionViewControllerDelegate
