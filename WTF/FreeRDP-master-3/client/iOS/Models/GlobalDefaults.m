...
- (ComputerBookmark*)newTestServerBookmark
{
    ...
    [bm setLabel:@"瑞友天翼演示服务器"];
    [[bm params] setValue:@"demo.realor.cn" forKey:@"hostname"];
    ...
    [[bm params] setValue:@"kdtest" forKey:@"username"];
    [[bm params] setValue:@"kdtest" forKey:@"password"];
    [[bm params] setInt:8000 forKey:@"port"];
	return bm;
}
