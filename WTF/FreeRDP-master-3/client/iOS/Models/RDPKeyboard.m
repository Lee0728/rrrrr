...
- (void)sendctrlleftkey
{
    [self sendVirtualKey:VK_LCONTROL up:NO];
    [self sendVirtualKey:(VK_LEFT | KBDEXT) up:NO];
    [self sendVirtualKey:(VK_LEFT | KBDEXT) up:YES];
    [self sendVirtualKey:VK_LCONTROL up:YES];
    //[self sendVirtualKey:VK_KEY_1 up:NO];
    //[self sendVirtualKey:VK_KEY_1 up:YES];

}
- (void)sendctrlrightkey
{
    [self sendVirtualKey:VK_LCONTROL up:NO];
    [self sendVirtualKey:(VK_RIGHT | KBDEXT) up:NO];
    [self sendVirtualKey:(VK_RIGHT | KBDEXT) up:YES];
    [self sendVirtualKey:VK_LCONTROL up:YES];
    //[self sendVirtualKey:VK_KEY_2 up:NO];
    //[self sendVirtualKey:VK_KEY_2 up:YES];
}
@end
