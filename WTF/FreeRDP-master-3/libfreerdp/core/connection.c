...
BOOL rdp_client_connect(rdpRdp* rdp)
{
	...
	nego_init(rdp->nego);
    printf("the set safegateway is %d",settings->safegateway);
	nego_set_target(rdp->nego, settings->ServerHostname, settings->ServerPort, settings->safegateway,settings->Sessionid);
